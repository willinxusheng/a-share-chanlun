...
def build_banner(radar_json):
    ...
    try:
        ...
        if asof:
            inner.append('<span style="opacity:.8;font-size:12px">数据截至 %s%s</span>' % (asof, " · " + bt if bt else ""))
        inner.append(pills)
