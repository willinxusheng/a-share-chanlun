...
# R345: 2027 条目为「农历历法公历日期(历法事实) + 惯例连休」前瞻估算(与 report.py
# _A_SHARE_HOLIDAYS 同源)——30 交易日预测带自 2026-12 下旬(实证 T0=12-25)起触及
# 2027 春节, 若无表则 2/5/2/8 被当交易日致预测点错位(R245 同型); 国务院 2027 安排
# 约 2026-11 发布后须按官方核对本表。春节 2/6(六)初一, 2/6-2/7 周末由 weekday 过滤;
# 清明 4/5(一)/4/6(二); 劳动 5/1(六)起, 5/3-5/5 入表; 端午 6/9(三)起; 中秋 9/15(三)起。
_CN_HOLIDAYS = {
    "2026": {"01-01", "01-02",
